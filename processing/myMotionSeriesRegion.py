...
class myMotionSeriesRegion():
    ''' myMotionSeriesRegion - processes the series of five images in a row, looking for motion between the frames.  Creates a threshold of image changes between snapshots, and keeps track of all thresholds between images.  Once the sum of the thresholds is computed, use erosion/dilation to create regions.  Count the regions and return the masked image. '''
